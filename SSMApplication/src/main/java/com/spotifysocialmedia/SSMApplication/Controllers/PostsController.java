...
public class PostsController {
    ...
    public @ResponseBody ArrayList<Posts> getAllPosts() throws SQLException {
        ...
        try {
            ...
            resultSet = statement.executeQuery("select * from posts inner join users on users.userid = posts.userid where users.isSilenced = 0 AND posts.isDeleted = 0;");
    ...
    public @ResponseBody ArrayList<Posts> getAllPostsByArtist(@PathVariable("artistname") String artistName) throws SQLException {
        ...
        try {
            statement = connection.createStatement();
            resultSet = statement.executeQuery("select * from posts inner join users on users.userid = posts.userid where users.isSilenced = 0 AND posts.artist = '" + artistName + "' AND posts.isDeleted = 0 order by createdOn desc;");
            while (resultSet.next()) {
                postID = resultSet.getInt("postID");
                userID = resultSet.getInt("userID");
                postText = resultSet.getString("postText");
    ...
    public @ResponseBody ArrayList<Posts> getAllPostsByAlbum(@PathVariable("artistname") String artistName, @PathVariable("albumname") String albumName) throws SQLException {
        ...
        try {
            statement = connection.createStatement();
            resultSet = statement.executeQuery("select * from posts inner join users on users.userid = posts.userid where users.isSilenced = 0 AND posts.artist = '" + artistName + "' AND posts.album = '" + albumName +"' AND posts.isDeleted = 0 order by createdOn desc;");
            while (resultSet.next()) {
                postID = resultSet.getInt("postID");
                userID = resultSet.getInt("userID");
                postText = resultSet.getString("postText");
    ...
    public @ResponseBody ArrayList<Posts> getAllPostsBySong(@PathVariable("artistname") String artistName, @PathVariable("songname") String songName) throws SQLException {
        ...
        try {
            statement = connection.createStatement();
            resultSet = statement.executeQuery("select * from posts inner join users on users.userid = posts.userid where users.isSilenced = 0 AND posts.artist = '" + artistName + "' AND posts.song = '" + songName +"' AND posts.isDeleted = 0 order by createdOn desc;");
            while (resultSet.next()) {
                postID = resultSet.getInt("postID");
                userID = resultSet.getInt("userID");
                postText = resultSet.getString("postText");
